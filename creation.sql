...
CREATE TABLE FATURA
(
	FATURA_NO INT PRIMARY KEY REFERENCES TAHSILAT(TAHSILAT_ID),
	TUTAR SMALLMONEY,
	TARIH DATE,
	KULLANICI_ID INT FOREIGN KEY REFERENCES KULLANICI(KULLANICI_ID),
);
...
INSERT INTO KULLANICI VALUES (1, 'Faruk', 'MAIL_1'),
							 (2, 'Ugur', 'MAIL_2'),
							 (3, 'Nurullah', 'MAIL_3'),
							 (4, 'Umit', 'MAIL_4'),
							 (5, 'Ahmet', 'MAIL_5'),
...
INSERT INTO YAYIMCI VALUES (1,'YAYIMCI_MAIL_1','YAYIMCI1','1999-01-03','YAYIMCI_SITE_1'),
						   (2,'YAYIMCI_MAIL_2','YAYIMCI2','1992-03-12','YAYIMCI_SITE_2'),
						   (3,'YAYIMCI_MAIL_3','YAYIMCI3','1990-01-03','YAYIMCI_SITE_3'),
						   (4,'YAYIMCI_MAIL_4','YAYIMCI4','2002-12-02','YAYIMCI_SITE_4'),
						   (5,'YAYIMCI_MAIL_5','YAYIMCI5','2005-01-05','YAYIMCI_SITE_5');

INSERT INTO YAPIMCI VALUES (1,'YAPIMCI_MAIL_1','YAPIMCI 1','1989-03-11','YAPIMCI_SITE_1'),
						   (2,'YAPIMCI_MAIL_2','YAPIMCI 2','1996-04-01','YAPIMCI_SITE_2'),
						   (3,'YAPIMCI_MAIL_3','YAPIMCI 3','1984-07-06','YAPIMCI_SITE_3'),
						   (4,'YAPIMCI_MAIL_4','YAPIMCI 4','1980-03-08','YAPIMCI_SITE_4'),
						   (5,'YAPIMCI_MAIL_5','YAPIMCI 5','1987-02-02','YAPIMCI_SITE_5');
...
INSERT INTO KATEGORILER VALUES (1,'FUTBOL'),
							   (2,'ARABA YARIS'),
							   (3,'STRATEJI'),
							   (4,'BIRINCI SAHIS NISANCI'),
							   (5,'BULMACA'),
							   (6,'ACIK DUNYA'),
							   (7,'AKSIYON'),
							   (8,'COK OYUNCULU'),
							   (9,'TEK OYUNCULU'),
							   (10,'UCUNCU SAHIS NISANCI'),
							   (11,'ROL YAPMA'),
							   (12,'HACK AND SLASH');

INSERT INTO ODEMETURU VALUES (1,'KREDI KARTI'),
							 (2,'PAYPAL');
